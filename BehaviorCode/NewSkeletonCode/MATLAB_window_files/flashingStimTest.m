...
totalCyclesOn = input.tCyclesOn{trN};
leverpressoffset = input.tTrialRemainingOffMs{trN} - input.tTrialRemainingOnMs{trN};
reqHoldTimeMs = double((totalCycleTimeMs*totalCyclesOn)+leverpressoffset);
