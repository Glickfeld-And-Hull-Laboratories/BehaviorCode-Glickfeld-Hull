...
'tGratingSpeedDPS', ...
'tSurroundGratingContrast', ...
'tSurroundGratingDiameterDeg', ...
'tSurroundGratingDirectionDeg', ...
'tDoCenterGrating', ...
'tDoSurroundGrating', ...
'tNStimAccepted', ...
'frameCountN', ...
...
input.constList = { 'subjectNum',...
    ...
    'surroundGratingDiameterDeg',...
    'surroundGratingDirectionDiff',...
    'fractCenterOnly',...
    'fractSurroundOnly',...
    'doRand',...
    'doWheelSpeed'};
...
disp(sprintf('Trial %d: Az %d, El %d, Con %1.2f, Dir %d deg, SF %1.2f CPD, TF %d Hz, Sz %d deg', ...
    trN, input.tGratingAzimuthDeg{trN}, input.tGratingElevationDeg{trN}, input.tGratingContrast{trN}, input.tGratingDirectionDeg{trN}, input.tGratingSpatialFreqCPD{trN}, input.tGratingSpeedDPS{trN}, chop(input.tGratingDiameterDeg{trN},2)));


%% Run Plotting Function
input.holdStartsMs = input.tThisTrialStartTimeMs;
input = exptRunSubfunctions(ds, input, { @plotVisStim_context });
