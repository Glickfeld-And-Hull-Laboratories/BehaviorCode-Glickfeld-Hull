...
dirs = input.gratingDirections;
ddirs = input.dGratingDirections;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Performance Values
        ...
        tStr = sprintf( ['Target grating \n', ...
         ...
         dStr = sprintf( ['Target grating \n', ...
                 ...
                 'Direction (deg): %s \n', ...
        				 ...
        				 'Speed (dps) = %s \n', ...
        				 'Contrast = %s \n'], ...
                        input.dGratingDurationMs, ...
                        mat2str(ddirs), ...
                        input.dGratingAzimuthDeg, input.dGratingElevationDeg, ...
                        input.dGratingDiameterDeg, ...
                        input.dGratingSpatialFreqCPD, ...
                        input.dGratingSpeedDPS, ...
                        input.dGratingContrast);
