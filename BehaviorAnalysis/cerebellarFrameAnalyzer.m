...
blank = zeros(1, cell2mat(input.counter(end)));    %JH Fix: expands stimOnIx to account for dropped frames. It already adjusts the stimOn values. 
blank(stimOnFrame)=1;
stimOnIx = blank; 
...
for i=1:nTrs,
    ...
    emptyMat = [emptyMat locoMatFrame];
    ...
    emptyTimes = [emptyTimes locoTimeUs];
