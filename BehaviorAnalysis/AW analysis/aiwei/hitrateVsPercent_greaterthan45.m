...
%     stdlevelone= [];
    ...
    TotalTargetReactmean(1) =  mean(cell2mat_padded(TRs));
    TotalTargetReactstd(1) = std(cell2mat_padded(TRs)/ sqrt(length(TRs)));
    ...
    TotalTargetReactmean(2) =  mean(cell2mat_padded(TRs));
    TotalTargetReactstd(2) = std(cell2mat_padded(TRs)/ sqrt(length(TRs)));
    ...
    TotalTargetReactmean(3) =  mean(cell2mat_padded(TRs));
    TotalTargetReactstd(3) = std(cell2mat_padded(TRs)/ sqrt(length(TRs)));
