...
%%  EMILY hi. rohan left/right index comment
LeftTrials=find(tLeftTrial);
LeftTrials_idx=zeros(1,length(RxnTime))
LeftTrials_idx(LeftTrials)=1;

RxnTimesl=RxnTimes(LeftTrials)
%%
