...
mouse_name = '*1400*';%should be mouse name, must be starred for dir function to work 
first_pass_filenames = 'i1400-18'; %should be mouse name and year
start_date = '181219';
end_date = '181226';
...
date_idx = strfind(mouse_idx, 'i1400-18');
